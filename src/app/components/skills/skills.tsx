...
export default function Skills() {
  return (
    <section className="mt-[40vh] pb-[10%] lg:mb-0" id="skills">
      ...
      <figure className="flex justify-center items-center w-full absolute top-0 left-1/2 -translate-1/2">
        ...
        <span className="capitalize text-9xl absolute top-1/2 left-1/2 transform -translate-1/2 z-0 text-stone-300 font-extrabold opacity-50">
          Skills
          {/* <span
